...
#define NameArr @[@"简单",@"基本(支持旋转，消失后代理)",@"自定义方向",@"自定义边框和背景颜色(uv需求)",@"自定义背景图片"]
#define VCArr   @[@"EZBaseViewController",@"EZGameViewController",@"EZOrientationsViewController",@"EZUvViewController",@"EZImageViewController"]
